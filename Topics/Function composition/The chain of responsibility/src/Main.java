...
class ChainOfResponsibilityDemo {
     ...
     */
    static RequestHandler commonRequestHandler = wrapInRequestTag
            .combine(createDigest.combine(wrapInTransactionTag)); // !!! write a combination of existing handlers here
    ...
    interface RequestHandler {
        ...
        default RequestHandler combine(RequestHandler other) {
            return h -> this.handle(other.handle(h));
        }
    }
